...
export function getBrandByCategoryId(category_id) {
  return request({
    url: `admin/promotion/exchange-cats/${category_id}/brands`,
    method: 'get'
  })
}
...
export function getSpecsByCategoryId(category_id) {
  return request({
    url: `admin/promotion/exchange-cats/${category_id}/specs`,
    method: 'get'
  })
}
...
export function deleteCategory(ids) {
  ...
  return request({
    url: `admin/promotion/exchange-cats/${ids}`,
    method: 'delete'
  })
}
...
export function getCategoryParams(category_id) {
  return request({
    url: `admin/promotion/exchange-cats/${category_id}/param`,
    method: 'get'
  })
}

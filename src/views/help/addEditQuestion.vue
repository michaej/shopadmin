  ...
  <div v-loading="loading">
    ...
    <div class="content-goods-publish">
      ...
      <el-form
        ...
        <div class="base-info-item">
          <div>
            <el-form-item label="问题分类" prop="question_class_two_id">
              <el-input v-model="tableData.question_class_two_id" maxlength="60" minlength="3" placeholder="3-60个字符"></el-input>
            </el-form-item>
            <el-form-item label="问题描述" prop="description">
              <el-input v-model="tableData.description" maxlength="60" minlength="3" placeholder="3-60个字符"></el-input>
            </el-form-item>
          </div>
        </div>
        ...
        <div class="content-goods-publish">
          <el-form-item class="goods-intro">
            <el-input
              type="textarea"
              :autosize="{ minRows: 8, maxRows: 4}"
              placeholder="请输入内容"
              v-model="tableData.detail">
            </el-input>
            <!-- <UE ref="ue" v-model="tableData.detail" :defaultMsg="tableData.detail"></UE> -->
          </el-form-item>
        </div>
      </el-form>
    </div>
    ...
    <div class="footer">
      <el-button-group>
        <el-button type="primary" @click="aboveGoods">保存</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      GET_Category(){
        ...
        API_goodsCategory.getQuestionCommonDetail(params).then(res=>{
          this.tableData = res
        })
      },
      // 获取草稿箱
      ...
      aboveGoods() {
        ...
        if(id){
          let params_id = {
            ...
            question_class_two_id: this.tableData.question_class_two_id,
            detail: this.tableData.detail,
          }
          API_goodsCategory.getQuestionCommonUpdate(params_id).then(() =>{
          ...
          API_goodsCategory.getQuestionCommonAdd(params).then(() =>{

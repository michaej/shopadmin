  ...
  <div>
    ...
    >
      <template slot="table-columns">
        <!--店主身份-->
        <el-table-column prop="shop_id" label="店主身份"/>
        <!--店铺名称-->
        <el-table-column prop="shop_name" label="店铺名称"/>
        <!--会员名称-->
        <el-table-column prop="member_classify" label="店铺分类"/>
        <!--申请时间-->
        <el-table-column prop="member_time" label="申请时间"/>
        <!--联系人姓名-->
        <el-table-column prop="member_phonename" label="联系人姓名"/>
        <!--联系人手机-->
        <el-table-column prop="member_phone" label="联系人手机"/>
        <!--所在地-->

    ...
    <el-form :model="shopForm" :rules="shopRules" ref="shopForm" inline label-width="130px">
      <el-tabs v-model="tableName" ref="tabs">
        <el-tab-pane label="门店信息" name="base">
          <el-form-item label="门店名称" prop="company_name">
          ...
          <el-form-item label="门店分类" prop="link_phone">
            <el-input v-model="shopForm.link_phone" :maxlength="11"></el-input>
          </el-form-item><br />
          ...
          <el-form-item label="门店地址" prop="link_phone">
            <el-input v-model="shopForm.link_phone" :maxlength="11"></el-input>
          </el-form-item><br />
          <el-form-item label="有效证件" prop="legal_img">
            <el-upload
        ...
        <el-tab-pane label="店主信息" name="legal">
          ...
          <el-form-item label="手机号码" prop="license_num">
          ...
          <br>
          <el-form-item label="证件照片" prop="licence_img">
            <el-upload
              class="avatar-uploader"
              :action="MixinUploadApi"
              :show-file-list="false"

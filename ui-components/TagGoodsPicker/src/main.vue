    ...
    <div class="goods-picker-body">
      <div class="goods-picker-search">
        <!--<div class="item-search">-->
          <!--<span>搜索范围</span>-->
          <!--&lt;!&ndash; <en-category-picker-->
            <!--@changed="(category) => { params.category_path = category ? category.category_path : '' }"-->
            <!--:api="categoryApi"-->
            <!--placeholder="商品分类"-->
            <!--clearable-->
          <!--/> &ndash;&gt;-->
          <!--<el-select v-model="value" placeholder="请选择店铺" class="shopClassify" clearable @change="optionChange">-->
            <!--<el-option-->
            ...
            <!--</el-option>-->
          <!--</el-select>-->
          <!--<el-select v-model="shopValue" placeholder="请选择商品分类" class="shopClassify" clearable @change="changeClassify">-->
            <!--<el-option-->
              <!--v-for="item in shopClassify"-->
              <!--:key="item.value"-->
              <!--:label="item.name"-->
              <!--:value="item.category_path">-->
            <!--</el-option>-->
          <!--</el-select>-->
          <!--&lt;!&ndash; <en-shop-picker-->
            <!--v-if="type === 'admin'"-->
            <!--clearable-->
            <!--@changed="(shop) => { params.sellerId = shop.shop_id || 0 }"-->
          <!--/> &ndash;&gt;-->
        ...
        <div class="item-search">
          <span>查找商品</span>
          <el-input v-model="params.goods_ids" placeholder="请输入商品名称，多个商品用逗号隔开，中英文都可以。" clearable class="inline-input goods-ids"/>
